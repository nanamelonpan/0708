...
/**
 * Servlet implementation class Physics
 */
@WebServlet(name = "/Physics",
urlPatterns = {"/phy"})
public class Physics extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/physics.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		/* 入力項目を取得 */
		  String answer = req.getParameter("answer");
			...
			String answer11= req.getParameter("answer11");
			req.setAttribute("answer11", answer11);
			
		
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/jsp/physics2.jsp");
